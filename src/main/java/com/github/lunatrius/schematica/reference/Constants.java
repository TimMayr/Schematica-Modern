...
public class Constants {
	public static class Inventory {
		...
		public static class SlotOffset {
			...
			public static int HOTBAR = INVENTORY + Size.INVENTORY;
		}

		public static class InventoryOffset {
			public static final int HOTBAR = 0;
			public static int INVENTORY = HOTBAR + 9;
		}
	}
	...
	public static class World {
		public static int MINIMUM_COORD = -30000000;
		public static int MAXIMUM_COORD = 30000000;
	}
}
