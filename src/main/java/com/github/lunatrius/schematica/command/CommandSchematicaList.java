	...
	public static ArgumentBuilder<CommandSource, ?> register() {
		return Commands.literal(Names.Command.List.NAME)
		               .then(Commands.argument("page", IntegerArgumentType.integer(1)).executes((commandContext) -> {
			               ...
			               int pageSize = 9; //maximum number of lines available without opening
			               // chat.
			               ...
			               if (schematicDirectory == null) {
				               Reference.logger.warn("Unable to determine the schematic directory for " + "player {}",
				                                     player);
				               ...
				               for (File path : files) {
					               if (currentFile >= pageStart && currentFile < pageEnd) {
						               ...
						               ITextComponent removeLink = withStyle(
								               new TranslationTextComponent(Names.Command.List.Message.REMOVE),
						               ...
						               ITextComponent downloadLink = withStyle(
								               new TranslationTextComponent(Names.Command.List.Message.DOWNLOAD),
